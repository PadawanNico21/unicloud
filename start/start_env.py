...
server_api_hostname = os.getenv("API_HOSTNAME", server_hostname)
server_api_port = os.getenv("API_PORT")
server_api_protocol = os.getenv("API_PROTOCOL", "http")
replica_server_source = os.getenv("REPLICA_SERVER_SOURCE", client_dest)
...
unison_params = os.getenv(
    "UNISON_PARAMS", "#place additional params with UNISON_PARAMS env"
)
